...
export default function Home() {
  return (
    <div className='w-full h-screen bg-midnight' style={{backgroundSize: '80px 80px', backgroundImage: 'linear-gradient(to right, grey 1px, transparent 1px),linear-gradient(to bottom, grey 1px, transparent 1px)'}}>
      ...
      <Link href="/cover">
        <div className='w-full h-screen flex flex-col items-center justify-center justify-between py-10' style={{backgroundSize: '16px 16px', backgroundImage: 'linear-gradient(to right, rgb(240, 240, 240, 0.2) 1px, transparent 1px),linear-gradient(to bottom, rgb(240, 240, 240, 0.2) 1px, transparent 1px)'}}>
          <div></div>
          <div className='flex flex-col items-center justify-center'>
            ...
            <Image className='w-[80%] max-h-[640px]' src="/globe-in-palms.svg" width={200} height={180} alt="" />
          </div>
