...
export default function Chapter() {
  return (
    <Layout
      ...
      <section className="h-screen bg-[#893136] text-white text-2xl py-24">
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-white rounded border-0 md:my-10"/>
        <p className="w-4/5 mx-auto">Innovations to faciliate healthy screentime usage among non-adults.</p>
        <p className="w-4/5 mx-auto mt-16">The problem : Our increasing digital footprint has left us more vulnerable to addiction the content of our screens, which could then lead to various mental health disorders.</p>
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-white rounded border-0 md:my-10"/>
      </section>
      <section className="bg-[#fffef7] text-[#893136] text-2xl flex flex-col items-center py-24">
