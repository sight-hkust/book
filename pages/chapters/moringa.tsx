  ...
  return (
    <Layout 
      ...
      <section className="h-screen bg-[#6067ae] text-white text-2xl py-24">
        ...
        <p className="w-4/5 mx-auto">First, it all started as a water purification project in Changshun County, Guizhou, China. Now it is a social enterprise empowering local female artists to preserve their local culture.</p>
        <p className="w-4/5 mx-auto mt-16">The problem : At first, the villagers in the mountainous regions of Changshun County were afflicted by flouride contaminated water, but then the villagers were moved out mandatorily of the affected area. Changshun County is also home to traditional batik art of the Buyi people.</p>
        ...
        <dl className="flex flex-col mx-auto w-4/5">
          ...
          <dl className="text-xl">(“Challenge Cup” National Competition – Hong Kong Regional Final)</dl>
        </dl>
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-white rounded border-0 md:my-10"/>
      </section>
      <section className="bg-[#fffef7] text-[#6067ae] text-2xl flex flex-col items-center py-24">
