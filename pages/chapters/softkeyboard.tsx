    ...
    <Layout
      ...
      <section className="h-screen bg-[#647ebe] text-white text-2xl py-24">
        ...
        <dl className="flex flex-col mx-auto w-4/5">
          ...
          <dl className="text-xl">(Samsung Solve for Tomorrow Competition)</dl>
        </dl>
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-white rounded border-0 md:my-10"/>
      </section>
      <section className="bg-[#fffef7] text-[#142a44] text-2xl flex flex-col items-center py-24">
        <h1 className="font-black text-5xl">Elizabeth</h1>
        <h2 className="font-medium text-lg">SIGHT member in 2016</h2>
        <h3 className="text-lg">Softkeyboard</h3>
        <article className="text-xl w-4/5 mx-auto flex flex-col space-y-10">
          <p className="first-letter:text-4xl">SIGHT is an eye-opening journey for university students to have hands-on experience in solving real-world issues. While working as a member of the joystick keyboard team, I was given the opportunity to meet and get to understand the daily struggles of MPS patients. The idea of a joystick keyboard was thus generated with the hope of improving their efficiency in day-to-day computer usage.</p>
