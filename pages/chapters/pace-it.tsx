  ...
  return (
    <Layout
      ...
      <section className="h-screen bg-[#1f2549] text-white text-lg sm:text-2xl py-16 sm:py-24">
        ...
        <p className="w-5/6 sm:w-4/5 mx-auto mt-16">The problem : Bicycles and motorbikes are common methods of transportation, yet safety practices such as wearing helmets is not widespread, leading to serious accidents and injuries.</p>
        <hr className="my-4 mx-auto w-5/6 sm:w-4/5 h-0.5 bg-white rounded border-0 md:my-10"/>
      </section>
      <section className="h-screen bg-[#fffef7] text-[#1f2549] text-lg sm:text-2xl flex flex-col items-center py-16 sm:py-24">
