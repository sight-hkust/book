...
export default function Chapter() {
  return (
    <Layout 
      ...
      <section className="h-screen bg-[#fffef7] text-[#142a44] text-2xl py-24">
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-[#142a44] rounded border-0 md:my-10"/>
        <p className="w-4/5 mx-auto">Leveraging Stanford d.school’s Designing for Life curriculum for early secondary school students.</p>
        <p className="w-4/5 mx-auto mt-16">The problem : The COVID pandemic along with subsequent government policies had at times left teaching and learning in a jumble. But amid all this we saw a chance to also experiment with something novel and untested in Hong Kong, prototyping with secondary school students their ideal lives.</p>
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-[#142a44] rounded border-0 md:my-10"/>
      </section>
      <section className="h-screen bg-[#fcf37d] text-[#142a44] text-2xl flex flex-col items-center py-24">
...
of kind volunteers, we linked students up with professionals and experts of their interested fields to flesh out opportunities and possibilities down those paths. The program included a cameo from Dong Fong Sing of 100Most fame, who as the guest speaker encouraged students to find their interests and become experts in them.</p>
      ...
      <section className="bg-[#fffef7] text-[#142a44] text-2xl flex flex-col items-center py-24">
        <h1 className="font-black text-5xl">Leung Wing Mui</h1>
        <h2 className="font-medium text-lg">Vice-principal</h2>
        <h3 className="text-lg">Kowloon Sam Yuk Secondary School</h3>
        <article className="text-xl w-4/5 mx-auto flex flex-col space-y-10">
          <p className="first-letter:text-4xl">“Design thinking is crucial in problem-solving by redefining problems and create solution to prototype and test. Amid the 4-weeks programme, our students’ have participated in various workshops, focusing on designing and redesigning what
