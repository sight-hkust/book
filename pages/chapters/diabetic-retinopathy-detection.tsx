...
export default function Chapter() {
  ...
  return (
    <Layout
      ...
      <Image className="w-screen" src={`/covers/${router.pathname.split('/').slice(-1)}.png`} width={1500} height={1320} alt=""/>
      ...
      <section className="bg-[#fffef7] text-[#142a44] flex flex-col items-center py-16 sm:py-24">
        ...
        <article className="test-base sm:text-xl w-5/6 sm:w-4/5 mx-auto flex flex-col space-y-10">
          ...
          <Image className="mx-auto w-10/12 sm:w-11/12" src="/artworks/bench.png" width={644} height={662} alt=""/>
        ...
        <Image className="mx-auto w-2/3 sm:w-1/2 max-w-md mt-16 sm:mt-24" src="/artworks/reynaldi.png" alt="" width={726} height={1142}/>
      </section>
    </Layout>
  )
}