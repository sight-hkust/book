...
export default function Chapter() {
  return (
    <Layout
      ...
      <section className="h-screen bg-[#fffef7] text-[#c12239] text-2xl py-24">
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-[#c12239] rounded border-0 md:my-10"/>
