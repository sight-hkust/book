...
export default function Chapter() {
  return (
    <Layout 
      ...
      <section className="h-screen bg-[#577360] text-[#020203] text-2xl py-24">
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-[#020203] rounded border-0 md:my-10"/>
        <p className="w-4/5 mx-auto">Malaria prevention at a refugee settlement in Sadon, Myanmar.</p>
        <p className="w-4/5 mx-auto mt-16">The problem : Malaria is endemic to the area which hosts a settlement of internally displaced people (IDPs).</p>
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-[#020203] rounded border-0 md:my-10"/>
      </section>
      <section className="bg-[#fffef7] text-[#142a44] text-2xl flex flex-col items-center py-24">
        <h1 className="font-black text-5xl">Rainbow</h1>
        <h2 className="font-medium text-lg">SIGHT member in 2022</h2>
        <h3 className="text-lg">Malaria Prevention</h3>
...
or equipment to diagnose malaria, it really hit me how this project does have the potential to impact people’s lives. It really made me tear up thinking about how people are dying and affected by malaria, but they are unable to receive treatment or any help.</p>
      ...
      <section className="bg-[#577360] text-[#fffef7] text-2xl flex flex-col items-center py-24">
        <h1 className="font-black text-5xl">Gabriel</h1>
        <h2 className="font-medium text-lg">SIGHT member in 2022</h2>
        <h3 className="text-lg">Malaria Prevention</h3>
        <article className="text-xl w-4/5 mx-auto flex flex-col space-y-10">
      ...
      <section className="bg-[#fffef7] text-[#142a44] text-2xl flex flex-col items-center py-24">
        <h1 className="font-black text-5xl">Yanna</h1>
        <h2 className="font-medium text-lg">SIGHT member in 2022</h2>
        <h3 className="text-lg">Malaria Prevention</h3>
        <article className="text-xl w-4/5 mx-auto flex flex-col space-y-10">
...
can really be helpful, and motivates me to continue working on the project after the semester ends.</p>
      ...
      <section className="bg-[#577360] text-[#fffef7] text-2xl flex flex-col items-center py-24">
        <h1 className="font-black text-5xl">Claire</h1>
        <h2 className="font-medium text-lg">SIGHT member in 2022</h2>
        <h3 className="text-lg">Malaria Prevention</h3>
        <article className="text-xl w-4/5 mx-auto flex flex-col space-y-10">
