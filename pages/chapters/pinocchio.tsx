...
export default function Chapter() {
  return (
    <Layout 
      ...
      <section className="h-screen bg-[#f2948f] text-white text-2xl py-24">
        <hr className="my-4 mx-auto w-4/5 h-0.5 bg-white rounded border-0 md:my-10"/>
        <p className="w-4/5 mx-auto">A platform for mental wellness dedicated to HKUST students.</p>
        <p className="w-4/5 mx-auto mt-16">The problem : Mental health is often a tabooed subject in Hong Kong, but with 1 out of 10 Hong Kongers displaying symptoms of PTSD
and the affects of COVID restrictions, the need for a safe space to discussion mental wellbeing is all the more dire.</p>
      ...
      <section className="bg-[#fffef7] text-[#142a44] flex flex-col items-center py-24">
        <h1 className="font-black text-5xl">Tiffany</h1>
        <h2 className="font-medium text-lg">SIGHT member in 2020</h2>
        <h3 className="text-lg">Pinocchio</h3>
...
a lot closer (despite having only met each other virtually), and we were able to learn how to work together in a collaborative and efficient manner. In fact, now that I am looking back, I am sure that without the push and support of our advisors, Pinocchio would have definitely not grown the way it has today.
      ...
      <section className="bg-[#fffef7] text-[#142a44] text-2xl flex flex-col items-center py-24">
        <h1 className="font-black text-5xl">Minjin</h1>
        <h2 className="font-medium text-lg">SIGHT member in 2020</h2>
        <h3 className="text-lg">Pinocchio</h3>
        <article className="text-xl w-4/5 mx-auto flex flex-col space-y-10">
          <p className="first-letter:text-4xl">
