    ...
    <Layout
      ...
      <section className="h-screen bg-[#1f2549] text-white text-lg sm:text-2xl py-16 sm:py-24">
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/pace-it.png`} width={430} height={150} alt=""/>
        </div>
      </section>
      <section className="bg-[#fffef7] text-[#1f2549] text-lg sm:text-2xl flex flex-col items-center">
        <div className="w-full flex mb-16 sm:mb-24">
          <ExportedImage className="w-1/2" src="/media/pace-it-1.jpg" alt="" width={1364} height={592}/>
          <ExportedImage className="w-1/2" src="/media/pace-it-2.jpg" alt="" width={1364} height={592}/>
        </div>
        ...
        <ExportedImage className="w-screen mt-16 sm:mt-24" src="/media/pace-it-3.jpg" alt="" width={1498} height={778}/>
      </section>
    </Layout>
  )
}