    ...
    <Layout
      ...
      <ExportedImage className="w-3/4 sm:w-2/3 mx-auto" src={`/titles/eyessistant.png`} width={876} height={162} alt=""/>
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/eyessistant.png`} width={430} height={150} alt=""/>
        </div>
        <ExportedImage className="w-screen mt-16 sm:mt-24" src="/media/eyessistant-1.jpg" alt="" width={1364} height={592}/>
      </section>
...
our envisioned solutions. We thought this was a good time to schedule our second meeting with our secondary supervising professor, Prof. Roger Cheng, to gather his comment on our progress.</p>
          ...
          <ExportedImage className="mx-auto w-1/3 sm:w-1/5 mt-16 sm:mt-24" src="/artworks/rubaiyat.png" alt="" width={1080} height={744}/>
