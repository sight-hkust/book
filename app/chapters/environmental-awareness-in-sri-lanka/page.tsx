    ...
    <Layout
      ...
      <ExportedImage className="w-3/4 mx-auto" src={`/titles/environmental-awareness-in-sri-lanka.svg`} width={876} height={162} alt=""/>
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/environmental-awareness-in-sri-lanka.png`} width={430} height={150} alt=""/>
        </div>
        <ExportedImage className="w-screen mt-16 sm:mt-24" src={`/covers/environmental-awareness-in-sri-lanka.jpg`} alt="" width={1364} height={592}/>
      </section>
