    ...
    <Layout
      ...
      <section className="h-screen bg-[#893136] text-white text-lg sm:text-2xl py-16 sm:py-24">
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/reducing-digital-dependency-among-children.png`} width={430} height={150} alt=""/>
        </div>
      </section>
      <section className="bg-[#fffef7] text-[#893136] text-lg sm:text-2xl flex flex-col items-center">
        <ExportedImage className="w-screen mb-16 sm:mb-24" src="/media/reducing-digital-dependency-among-children-1.jpg" alt="" width={1498} height={776}/>
        ...
        <ExportedImage className="w-screen mt-16 sm:mt-24" src="/media/reducing-digital-dependency-among-children-2.jpg" alt="" width={1498} height={778}/>
      </section>
    </Layout>
  )
}