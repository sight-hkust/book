    ...
    <Layout 
      ...
      <section className="h-screen bg-[#ea5545] text-white text-lg sm:text-2xl py-16 sm:py-24">
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/drug-dispensing-box.png`} width={430} height={150} alt=""/>
        </div>
      </section>
      <section className="bg-[#fffef7] text-[#142a44] flex flex-col items-center py-24">
        <ExportedImage className="mx-auto max-w-sm w-2/5" src="/artworks/melody.png" width={644} height={662} alt=""/>
        ...
        <article className="text-base sm:text-xl w-5/6 sm:w-4/5 mx-auto flex flex-col space-y-10">
          <p className="first-letter:text-2xl sm:first-letter:text-4xl">My first project with SIGHT was DDX (Drug Dispensing Box), which is a drug carrier for the mobile pharmacy station in slum setting. I joined the project team when I
...
my perspective on things. I still remember her analogy of life as a closet with many drawers, and only the right drawer should be opened at the right time. I think this has a great impact on my life especially on my time management in specializing while diversifying my interests. I can put on many hats and invest time on things that I like while maintaining a healthy work-life balance.</p>
        ...
        <ExportedImage className="mx-auto w-2/3 sm:w-3/5 max-w-md" src="/artworks/ddx.png" alt="" width={918} height={856}/>
      </section>
    </Layout>
  )
}