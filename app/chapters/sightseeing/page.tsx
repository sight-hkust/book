    ...
    <Layout 
      ...
      <section className="bg-[#375ba7] text-white text-lg sm:text-2xl py-16 sm:py-24">
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/sightseeing.png`} width={430} height={150} alt=""/>
        </div>
        <ExportedImage className="mx-auto w-5/6 sm:w-3/5 mt-16 sm:mt-24" src="/covers/sightseeing.png" alt="" width={1080} height={744}/>
      </section>
      <section className="bg-[#fffef7] text-[#375ba7] text-lg sm:text-2xl flex flex-col items-center">
        <ExportedImage className="w-screen mb-16 sm:mb-24" src="/media/sightseeing-1.jpg" alt="" width={1498} height={776}/>
...
an app called SightSeeing. The team departed for Shantou on 9th June, 2019 and after several rounds of testing, briefed the counterparts on the specifics of the app on June 12th. The trip drew to a close and the team returned to Hong Kong on 16th June.</p>
        ...
        <ExportedImage className="w-screen mt-16 sm:mt-24" src="/media/sightseeing-2.jpg" alt="" width={1498} height={778}/>
      </section>
    </Layout>
  )
}