    ...
    <Layout 
      ...
      <ExportedImage className="w-3/4 mx-auto" src={`/titles/zi-saam-dim-sum.png`} width={876} height={162} alt=""/>
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/zi-saam-dim-sum.png`} width={430} height={150} alt=""/>
        </div>
        <ExportedImage className="w-screen mt-16 sm:mt-24" src={`/covers/zi-saam-dim-sum.png`} alt="" width={1364} height={592}/>
      </section>
...
is edible but also with soft texture is a huge challenge for me. Luckily after many lab sessions of practice, I have overcome this challenge and got the hang of how to make TMF without too many troubles.</p>
          ...
          <ExportedImage className="mx-auto w-2/5 sm:w-1/5 mt-16 sm:mt-24" src="/artworks/daniel.png" alt="" width={1080} height={744}/>
