    ...
    <Layout 
      ...
      <section className="bg-[#6067ae] text-white text-lg sm:text-2xl py-16 sm:py-24">
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/moringa.png`} width={430} height={150} alt=""/>
        </div>
      </section>
      <section className="bg-[#fffef7] text-[#6067ae] text-lg sm:text-2xl flex flex-col items-center py-16 sm:py-24">
        ...
        <ExportedImage className="w-3/4 sm:w-2/5 mt-16 sm:mt-24 p-2 border-2 border-solid border-[#6067ae]" src="/media/moringa-1.jpg" alt="" width={598} height={400}/>
        <ExportedImage className="w-3/4 sm:w-2/5 mt-16 sm:mt-24 p-2 border-2 border-solid border-[#6067ae]" src="/media/moringa-2.jpg" alt="" width={598} height={400}/>
        <ExportedImage className="w-3/4 sm:w-2/5 mt-16 sm:mt-24 p-2 border-2 border-solid border-[#6067ae]" src="/media/moringa-3.jpg" alt="" width={598} height={400}/>
      </section>
    </Layout>
  )
}