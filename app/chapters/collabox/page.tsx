    ...
    <Layout
      ...
      <section className="h-screen bg-[#fffef7] text-[#ed8902] text-lg sm:text-2xl">
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/collabox.png`} width={430} height={150} alt=""/>
        </div>
      </section>
...
my thoughts and to test my beliefs. I just didn’t know how. One thing I knew though was I wanted to make a positive change, but to do that I had so much more to
learn. Fortunately SIGHT’s ideology seemed to check all the boxes. Joining SIGHT was the best decision I’ve made at HKUST, but it was also so much more. It is a rite of passage in my journey of believing that I can, and I should strive to make that difference.</p>
          <p>
...
and eventually come to life, and not even once did I find the teaching team trying to impose anything on me.
        ...
        <div className="w-4/5 flex justify-center sm:justify-end">
          <ExportedImage className="w-1/3 sm:w-1/4 mt-16 sm:mt-24 mr-0 sm:mr-32" src="/artworks/doris.png" alt="" width={1080} height={744}/>
        </div>
      </section>
      <section className="bg-[#fffef7] text-[#142a44] text-lg sm:text-2xl flex flex-col items-center py-16 sm:py-24">
        ...
        <article className="text-lg sm:text-xl w-5/6 sm:w-4/5 mx-auto flex flex-col space-y-10">
          ...
          <ExportedImage className="mx-auto w-1/3 sm:w-1/5 mt-16 sm:mt-24" src="/artworks/diya.png" alt="" width={1080} height={744}/>
          <p>
...
on the challenges they are encountering, and that an inclusive community can be maintained to benefit every party in need.</p>
        ...
        <ExportedImage className="mx-auto w-4/5 mt-16 sm:mt-24" src="/artworks/collabox.png" alt="" width={1080} height={744}/>
      </section>
    </Layout>
  )
}