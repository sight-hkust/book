    ...
    <Layout
      ...
      <section className="h-screen bg-[#fffef7] text-[#c12239] text-lg sm:text-2xl py-16 sm:py-24">
        ...
        <div className="w-5/6 mx-auto flex justify-center">
          <ExportedImage className="w-full sm:w-3/5" src={`/vectors/diabetic-retinopathy-detection.png`} width={430} height={150} alt=""/>
        </div>
      </section>
      <section className="bg-[#fffef7] text-[#142a44] flex flex-col items-center py-16 sm:py-24">
        <AuthorName name="Reynaldi"/>
        ...
        <article className="test-base sm:text-xl w-5/6 sm:w-4/5 mx-auto flex flex-col space-y-10">
          ...
          <ExportedImage className="mx-auto w-10/12 sm:w-11/12" src="/artworks/bench.png" width={644} height={662} alt=""/>
        ...
        <ExportedImage className="mx-auto w-2/3 sm:w-1/2 max-w-md mt-16 sm:mt-24" src="/artworks/reynaldi.png" alt="" width={726} height={1142}/>
      </section>
    </Layout>
  )
}