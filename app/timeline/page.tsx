                    ...
                    remarks.map(({ title, thumbnail }) => (
                      <li key={title} className='flex w-full h-auto md:h-[260px] items-center my-8 md:my-12'>
                        ...
                        </div>
                        {
                          thumbnail.length>0?(
                           <div className='ml-8'>
                             <ExportedImage className={`w-[240px] md:w-[320px] h-[120px] md:h-auto rounded-3xl shadow-xl mb-4`} style={{objectFit: "cover"}} src={`/media/timeline/${thumbnail}`} alt={title} width={320} height={160}/> 
